...
rank_file=${rank_dir}D21hs_1500padded_rank_file_for_TFEA.rnk
outdir=/Shares/down/heatshock/analysis_June2022/outfiles/PRO/TFEA_output/HOCOMOCO10/Eric_hs_via_padded_rank/
