...
outdir=/Shares/down/heatshock/analysis_June2022/outfiles/PRO/TFEA_output/HOCOMOCO11/Eric_hs/
...
--output ${outdir} \
--bed1 \
${beddir}Eric37_rep1.sorted_split_bidir_predictions.bed \
${beddir}Eric37_rep2.sorted_split_bidir_predictions.bed \
--bed2 \
${beddir}Eric42_rep1.sorted_split_bidir_predictions.bed \
${beddir}Eric42_rep2.sorted_split_bidir_predictions.bed \
--bam1 \
...
--fimo_motifs ${TFEAdir}/motif_files/HOCOMOCOv11_core_HUMAN_mono_meme_format.meme \
--cpus 16 \
--mem 100gb \
--output_type html \
