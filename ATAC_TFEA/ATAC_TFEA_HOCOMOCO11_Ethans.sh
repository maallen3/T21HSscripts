...
outdir=/Shares/down/heatshock/analysis_June2022/outfiles/ATAC/TFEA_output/HOCOMOCO11/Ethan_hs/
...
--output ${outdir} \
--bed1 \
${beddir}Ethan37_rep1.open.sorted.bed \
${beddir}Ethan37_rep2.open.sorted.bed  \
--bed2 \
${beddir}Ethan42_rep1.open.sorted.bed  \
${beddir}Ethan42_rep2.open.sorted.bed  \
--bam1 \
