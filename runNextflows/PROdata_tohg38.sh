...
mkdir -p /Shares/down/PRO/temp/
mkdir -p /Shares/down/heatshock/analysis_June2022/outfiles/PRO/Nascentflow_human/
...
nextflow run ${nextflowdir}main.nf --resume -profile hg38 --workdir '/Shares/down/PRO/temp/' --outdir '/Shares/down/heatshock/analysis_June2022/outfiles/PRO/Nascentflow_human/' --email mary.a.allen@colorado.edu --singleEnd --fastqs '/Shares/down/heatshock/analysis_June2022/fastq/PROseq_HS_lymphoblastiod/*.fastq.gz' --flip 
