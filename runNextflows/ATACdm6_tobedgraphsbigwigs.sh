...
mkdir -p /Shares/down/heatshock/analysis_June2022/outfiles/ATAC/ChipFlow_dros/mapped/mergedmappedfiles/
...
nextflow run ${nextflowdir}main.nf -profile dm6 --bams '/Shares/down/heatshock/analysis_June2022/outfiles/ATAC/ChipFlow_dros/mapped/mergedbams/*.sorted.bam' --workdir '/scratch/Users/allenma/temp/' --outdir '/Shares/down/heatshock/analysis_June2022/outfiles/ATAC/ChipFlow_dros/mapped/mergedmappedfiles/' --saveall --resume
