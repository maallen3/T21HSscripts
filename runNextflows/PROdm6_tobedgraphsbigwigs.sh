...
mkdir -p /Shares/down/heatshock/analysis_June2022/outfiles/PRO/BedgraphsandBigwigs_dros/
...
nextflow run ${nextflowdir}main.nf -profile dm6 --crams '/Shares/down/heatshock/analysis_June2022/outfiles/PRO/Nascentflow_dros/mapped/crams/*.sorted.cram' --workdir '/scratch/Users/allenma/temp/' --outdir '/Shares/down/heatshock/analysis_June2022/outfiles/PRO/BedgraphsandBigwigs_dros/' --saveall --singleEnd
