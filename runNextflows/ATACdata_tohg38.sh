...
nextflowdir=/Shares/down/heatshock/analysis_June2022/scripts/Nextflows/ChIP-Flow/
mkdir -p /Shares/down/ATAC/temp/
mkdir -p /Shares/down/heatshock/analysis_June2022/outfiles/ATAC/ChipFlow_human/
...
nextflow run ${nexflowdir}main.nf -profile slurm_grch38 --workdir '/Shares/down/ATAC/temp/' --outdir '/Shares/down/heatshock/analysis_June2022/outfiles/ATAC/ChipFlow_human/' --email mary.a.allen@colorado.edu --fastqs '/Shares/down/heatshock/analysis_June2022/fastq/ATAC_HS_lymphoblastiod/*{R1,R2}*.fastq.gz'
