...
sbatch --export=rootname=$rootname,indir=$indir,outdir=$outdir /Shares/down/heatshock/analysis_June2022/scripts/T21HSscripts/mergereplicatesandlink/makelink.sbatch
